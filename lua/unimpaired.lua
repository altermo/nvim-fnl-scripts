...
nno("[f", _5_)
for k, v in pairs({b = {opt = "background", on = "light", off = "dark"}, c = "cursorline", h = "hlsearch", l = "list", i = "ignorecase", n = "number", r = "relativenumber", s = "spell", u = "cursorcolumn", w = "wrap", d = "diff", t = {opt = "colorcolumn", on = "1,41,81,121,161,201,241"}, v = {opt = "virtualedit", on = "block,onemore"}, m = {opt = "conceallevel", on = 2, off = 0}, f = "foldenable", e = "scrollbind", p = {opt = "matchpairs", on = "(:),{:},[:]", off = ""}}) do
